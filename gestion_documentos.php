                        ...
                        <div class="col-lg-12">
                            <div class="ibox ">
                               ...
                               <?php 
                                    ...
                                    if (isset($_SESSION['multiple'])==1 ) {  ?>     
                                        <!-- select de contratistas --> 
                                        <div class="row">                                                                    
                                            <label class="col-2 col-form-label fondo"><b>Mandantes </b></label>
                                            <div style="text-align: right;" class="col-6">   
                                                <select style="border:1px solid #c0c0c0" name="contratista" id="contratista" class="form-control m-b"  onchange="selmandante(this.value)">
                                                    <?php                                           
                                        ...
                                        <?php 
                                                ...
                                                if ($acreditada==1) {   
                                                    if ($cant_doc>0) {               ?>
                                                        <a style="padding-top: 0.5%;;margin-left: 3%;margin-top: -0.5%;" class="font-bold" href="descargar.php?url=<?php echo $url ?>&rut=<?php echo $rut_contratista ?>" ><u>Descargar Documentos</u></a>
                                                    <?php } else { ?>
                                ...
                                <?php 
                                    # contratista con un solo mandante
                                        ...
                                        <div class="col-12">
                                            <div class="row">                                                                    
                                                <label  class="col-lg-12 col-sm-12 col-form-label fondo"><b> Mandante: </b><?php echo $razon_social ?></label>                                                       
                                            </div>
                                            <div class="row">                                                                    
                                                <label  class="col-lg-2 col-sm-12 col-form-label fondo"><b>Estado</b></label>
                                            ...
                                            <div class="row">   
                                                <label  class="col-lg-2 col-sm-12 col-form-label fondo"><b>Documentos</b></label>
                                                
                                                <?php 
                                                    $url ='doc/validados/'.$mandante.'/'.$_SESSION['contratista'].'/zip/';
                                                    if ($acreditada==1) {   
                                                        if ($cant_doc>0) {               ?>
                                                            <div  class="col-sm-6"><a  class="font-bold" href="descargar.php?url=<?php echo $url ?>&rut=<?php echo $rut_contratista ?>" ><u>Descargar Documentos</u></a></div> 
                                                        <?php } else { ?>
                                                            <div style="vertical-align:middle" class="col-sm-6"><label class="col-form-label badge badge-danger font-bold">Sin Documentos</label></div> 
                                                        <?php }   
                                                    } else { ?>    
                                                        <div  class="col-sm-6"><p style="margin-top: 0.5%;margin-left: 1%;"><span class="badge badge-danger">No Acreditada</span></p> </div> 
                                                    <?php } ?>     
                                            </div> 
                                        </div>
                                                ...
                                                <table style="width: 100%;" class="footable table" data-page-size="100" data-filter="#filter">
                                                    <thead >
                                                        <tr>
                                                            ...
                                                            <th style="width: 10%;" data-hide="phone">Verificado</th>
                                                            <th style="width: 15%;text-align: center" data-hide="phone">Adjuntar</th>
                                                            <th style="width: 6%;text-align: center"  data-hide="phone">N/A</th>
                                                            <th style="width: 10%;text-align: center" data-hide="phone">Estado</th>

                                                            <th style="width: ;visibility:collapse; display:none;" data-hide="all">Observaciones</th>
                                                        </tr>
                                                    </thead>
                                                        ...
                                                        foreach ($doc as $row) {
                                                            ...
                                                            <tbody>     
                                                                <tr>    
                                                                    ...
                                                                    <?php 
                                                                    if ($list_veri[$i]==0 and $list_com=="" ) {  ?>
                                                                           <td style="text-align:center;"><button title="Quitar documento" type="button" class="btn btn-sm btn-success" onclick="retirar(<?php echo $row  ?>,<?php echo $contratista  ?>,<?php echo $mandante  ?>,'<?php echo $rut_contratista  ?>','<?php echo $result['documento']  ?>')"> <i style="color: #fff;font-size: 15px;" class="fa fa-trash"  aria-hidden="true"></i> <?php echo $list_com ?></button></td>   
                                                                    <?php 
                                                                    } else {  ?>    
                                                                            <td style="text-align:center;"><button type="button" disabled class="btn btn-sm btn-secondary" > <i style="color: #fff;font-size: 15px;" class="fa fa-trash"  aria-hidden="true"></i></button></td>   
                                                                    <?php 
                                                                    }   ?>    
                                                                    
                                                                    <!-- documento  -->
                                                                    <td ><a id="td_documento<?php echo $i ?>" href="<?php echo $carpeta ?>" target="_blank"><?php echo $result['documento'] ?></a></td>
                                                                        ...
                                                                        if ($result_com['doc']==$result['documento']) {
                                                                                if ($result_com['leer_mandante']==1 and $result_com['leer_contratista']==1) { 
                                                                                        ...
                                                                                        <td  style="text-align:center">
                                                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                                <span id="span_seleccionar<?php echo $i ?>"  style="background: #282828;color: #000;border:#244b3b;color:#fff;width:100%" class="btn btn-default btn-file"><span class="fileinput-new">Archivo</span>
                                                                                        ...
                                                                                        if ($resul_noaplica['documento']==$row) { ?>    
                                                                                            <td style="text-align: center;"><input class="estilo" name="aplica[]" id="aplica<?php echo $i ?>" type="checkbox" onclick="modal_no_aplica(<?php echo $row ?>,<?php echo $i ?>,'<?php echo $result['documento'] ?>',<?php echo $contratista ?>,<?php echo $mandante ?>,'<?php echo $rut_contratista ?>' )" value="<?php echo $row  ?>" checked  /></td>
                                                                                        <?php 
                                                                                        } else { ?>
                                                                                    ...
                                                                                    <td style="text-align:center;"><div id="estado<?php echo $i ?>" style="font-size:10px" class="badge badge-danger p-xxs">EN PROCESO</div></td>
                                                                                <?php
                                                                                }      
                                                                                ...
                                                                                if ($result_com['leer_mandante']==0 and $result_com['leer_contratista']==0) { 
                                                                                        ...
                                                                                        if ($resul_noaplica['documento']==$row) { ?>
                                                                                            ...
                                                                                            <td id="div_seleccionar<?php echo $i ?>"  style="text-align:center">
                                                                                                    <div  class="fileinput fileinput-new" data-provides="fileinput">
                                                                                                        ...
                                                                                                        <span class="fileinput-exists">Cambiar</span><input id="carga_doc<?php echo $i ?>" onclick="prueba(<?php echo $i ?>,3)"  type="button"    /></span>
                                                                                                        <span class="fileinput-filename"></span>                                                             
                                                                                                        <a title="Quitar" href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none"> <i class="fa fa-times-circle" aria-hidden="true"></i></a>
                                                                                                    </div>
                                                                                            </td>
                                                                                            <td id="div_seleccionar2<?php echo $i ?>"  style="text-align:center;display:none">
                                                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                                        <span id="span_seleccionar<?php echo $i ?>" style="background: #282828;color: #000;border:#282828;color:#fff;width:100%" class="btn btn-default btn-file"><span class="fileinput-new">Archivo</span>
                                                                                                        <span class="fileinput-exists">Cambiar</span><input  type="file" id="carga_doc<?php echo $i ?>" name="carga_doc[]" accept="application/pdf"   /></span>
                                                                                                        <span class="fileinput-filename"></span>                                                             
                                                                                                        <a title="Quitar" href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none"> <i class="fa fa-times-circle" aria-hidden="true"></i></a>
                                                                                                    </div>
                                                                                            </td>
                                                                                        ...
                                                                                        <?php 
                                                                                            ...
                                                                                            <td  style="text-align:center">
                                                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                                    <span  style="background:#282828;color: #000;border:#282828;color:#fff;width:100%" class="btn btn-default btn-file"><span class="fileinput-new">Archivo</span>
                                                                                                    <span  class="fileinput-exists">Cambiar</span><input  type="file" id="carga_doc<?php echo $i ?>" name="carga_doc[]" accept="application/pdf"   /></span>
                                                                                                    <span class="fileinput-filename"></span>                                                             
                                                                                                    <a title="Quitar" href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none"> <i class="fa fa-times-circle" aria-hidden="true"></i></a>
                                                                                                </div>
                                                                                    ...
                                                                                    <td style="text-align:center"><div id="estado<?php echo $i ?>" style="font-size: 14px;" class="bg-info p-xxs"><b>OBSERVACION</b></div></td>
                                                                            <?php }
                                                                            # documento sin comentario     
                                                                            } else {                                                                            
                                                                                        ###############################  estado enviado #####################################################################
                                                                                        $estado='4'; ?>
                                                                                        ...
                                                                                        if ($resul_noaplica['documento']==$row) { ?>
                                                                                            ...
                                                                                            <td id="div_seleccionar<?php echo $i ?>"  style="text-align:center">
                                                                                                    <div  class="fileinput fileinput-new" data-provides="fileinput">
                                                                                                        <span id="span_seleccionar<?php echo $i ?>"  style="background: #282828;color: #000;border:#282828;color:#fff;width:100%" class="btn btn-default btn-file"><span class="fileinput-new">Archivo</span>
                                                                                                        <span  class="fileinput-exists">Cambiar</span><input id="carga_doc<?php echo $i ?>" onclick="prueba(<?php echo $i ?>,4)" name="carga_doc[]"  type="button" accept="application/pdf"   /></span>
                                                                                                        <span class="fileinput-filename"></span>                                                             
                                                                                                        <a title="Quitar" href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none"> <i class="fa fa-times-circle" aria-hidden="true"></i></a>
                                                                                                    </div>
                                                                                            </td>
                                                                                        ...
                                                                                        <td style="text-align:center"><div id="estado<?php echo $i ?>" style="font-size: 10px;" class="badge badge-info p-xxs"><b>EN PROCESO</b></div></td>

                                                                                        <!--  observaciones  -->     
                                                                                        <td>
                                                                                            <div class="btn-group"> 
                                                                                                    <textarea cols="100" rows="1" name="mensaje[]" id="mensaje<?php echo $i ?>" class="form-control" readonly=""><?php echo $list_com ?></textarea>
                                                                            ...
                                                                            <!-- adjuntar  -->
                                                                             <td  style="text-align:center">
                                                                                <div style="width: 100%;background: #969696;color:#fff"  class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    <span  style="background: #969696;color: #000;border:#969696;color:#fff" class="btn btn-default btn-file"><span class="fileinput-new">Validado</span>
                                                                                    <span  class="fileinput-exists">Cambiar</span><input  type="file" id="carga_doc<?php echo $i ?>" name="carga_doc[]" multiple="" accept="application/pdf"  /></span>                                                                     
                                                                                    <span class="fileinput-filename"></span>                                                             
                                                                                    <a title="Quitar" href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none"> <i class="fa fa-times-circle" aria-hidden="true"></i></a>
                                                                                </div>
                                                            ...
                                                            # si archivo no existe                                                              
                                                                ...
                                                                <tbody>     
                                                                    <tr>
                                                                        ...
                                                                        <!--<td id="div_seleccionar3<?php echo $i ?>"  style="text-align:center;display:none">
                                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    <span id="span_seleccionar<?php echo $i ?>" style="background: #282828;color: #000;border:##282828;color:#fff;width:100%" class="btn btn-default btn-file "><span class="fileinput-new">Archivo</span>
                                                                                    <span class="fileinput-exists">Cambiar</span><input id="carga_doc<?php echo $i ?>" name="carga_doc[]" type="file" accept="application/pdf"   /></span>
                                                                                    <span class="fileinput-filename"></span>                                                             
                                                                        ...
                                                                        <td id="div_seleccionar<?php echo $i ?>"  style="text-align:center;display:none">
                                                                                <div  class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    <span id="span_seleccionar<?php echo $i ?>"  style="background: #282828;color: #000;border:#282828;color:#fff;width:100%" class="btn btn-default btn-file btn-block"><span class="fileinput-new">Archivo</span>
                                                                                    <span  class="fileinput-exists">Cambiar</span><input id="carga_doc<?php echo $i ?>" onclick="prueba(<?php echo $i ?>,1)" name="carga_doc[]"  type="button" accept="application/pdf"   /></span>
                                                                                    <span class="fileinput-filename"></span>                                                             
                                                                                    <a title="Quitar" href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none"> <i class="fa fa-times-circle" aria-hidden="true"></i></a>
                                                                                </div>
                                                                        </td>-->
                                                                        ...
                                                                        <!-- esTado -->
                                                                        <td style="text-align:center"><div id="estado<?php echo $i ?>" style="font-size: 10px;"><span class="badge badge-danger p-xxs">NO ENVIADO</span></div></td>


                                                                        <!-- observaciones -->
                                                                        <td colspan="7">
                                                                            <div class="btn-group"> 
                                                                                <textarea cols="100" rows="1" name="mensaje[]" id="mensaje<?php echo $i ?>" class="form-control" readonly=""></textarea>
                                        ...
                                        <div class="table table-responsive">
                                                <table class="table table-stripped" data-page-size="15" data-filter="#filter">
                                                    <thead style="background:#e9eafb;color:#282828;font-weight:bold">
                                                        <tr>
                                                            <th style="width: 3%;border-right:1px solid #fff" >#</th>
                                                    ...
                                                    <?php 
                                                        #si la contratista es mandante
                                                        if ($result_contratista['dualidad']==1) { ?>
                                                                <tr>                                                                  
                                                                    <td colspan="2"><strong>SIN DOCUMENTOS. LA CONTRATISTA ES MANDANTE A LA MISMA VEZ.</strong></td>
                                                                </tr> 
                                                        <?php
                                                        } else {
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i ?></td>
                                                                    <td><a style="text-decoration:underline" href="<?php echo $carpeta ?>" target="_blank"><?php echo $result['documento'] ?></a></td>
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                            <tr>                                                                                                                    
                                                                                <td><?php echo $j ?></td>                                                                                    
                                                                                <!-- documento  -->
                                                                                <td><a style="text-decoration:underline" href="<?php echo $carpeta ?>" target="_blank"><?php echo $row['documento'] ?></a></td>
