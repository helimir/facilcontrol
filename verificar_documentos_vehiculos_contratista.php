...
if (isset($_SESSION['usuario']) and $_SESSION['nivel']==3) {
  ...
  if ($_SESSION['vehiculo']!='') {
        ...
        $razon_social="INACTIVO";     
            ...
            #$razon_social=squery($mandante);
        }




        $query_trabajador=mysqli_query($con,"select t.*, a.url_foto as foto_asignada from autos as t Left Join vehiculos_asignados as a On a.vehiculos=t.id_auto where t.id_auto='".$id."' and a.contrato='$contrato' ");
        $result_trabajador=mysqli_fetch_array($query_trabajador);
        $patente=$result_trabajador['patente'];
        $siglas=$result_trabajador['siglas'].'-'.$result_trabajador['control'];
        $marca=$result_trabajador['marca'];
        $modelo=$result_trabajador['modelo'];
        $year=$result_trabajador['year'];
        $control=$result_trabajador['control'];
        $rut=$result_trabajador['siglas'];

        $query_perfil_cargo=mysqli_query($con,"select * from perfiles_vehiculos where contrato='".$_SESSION['contrato']."' ");
        ...
        $query_cargos=mysqli_query($con,"select * from tipo_autos where id_ta='".$_SESSION['cargo']."' ");
        ...
        $query_obs=mysqli_query($con,"select o.*,t.url_foto from observaciones_vehiculo as o left join autos as t On t.id_auto=o.vehiculo where o.contrato='".$_SESSION['contrato']."' and o.vehiculo='".$id."' and o.estado!='2' ");
        $result_obs=mysqli_fetch_array($query_obs);
        $list_veri=unserialize($result_obs['verificados']);

        $query_ta=mysqli_query($con,"select * from vehiculos_acreditados where vehiculo='$id' and contrato='".$_SESSION['contrato']."' and estado!='2'  ");
        ...
        <head>
            ...
            <title>FacilControl | Documentos Vehiculos</title>
...
$("#modal_no_aplica").on('hidden.bs.modal', function () {        
    ...
    // Bind normal buttons
        ...
        function cargar_doc_trabajador(cant,rut_t,nom_contrato){
                ...
                if (contador>0 || contador2>0) {                        
                                ...
                                $.ajax({
                                        url: 'cargar_documentos_vehiculo.php',
                                        type: 'post',
                                        data:formData,
                                        contentType: false,
                                        processData: false,                                
            ...
            function seldoc(obj,id) {
                ...
                if (obj.checked == 1) {
                    ...
                    p.innerText="Documento Seleccionado";
                    //$('#carga_doc_t'+id).prop('disabled',true);
                    $('#doc_existe'+id).val(1);
                } else {
                    const p=document.getElementById("texto"+id);
            ...
            function cambiar_foto(rut,contrato,trabajador,perfil) {
                ...
                $.ajax({
                    url: 'cargar/cambiar_fotos_vehiculos.php',
                    type: 'post',
                    data:formData,
                    contentType: false,
                    processData: false,
    ...
    function agregar_foto_contrato(trabajador,contrato,contratista,mandante,cargo,perfil,rut) {
        ...
        var reader = new FileReader();        
        $.ajax({
            url: 'cargar/cargar_fotos_contrato_vehiculo.php',
            type: 'post',
            data:formData,
            contentType: false,
            processData: false,
    ...
    function agregar_foto_al_contrato(trabajador,contrato,contratista,mandante,cargo,perfil,rut) {
        ...
        var num_foto=$('#num_foto').val();
        $.ajax({
            url: 'cargar/cargar_fotos_al_contrato_vehiculos.php',
            type: 'post',
            data:formData,
            contentType: false,
            processData: false,
    ...
    function guardar_no_aplica(mandante) {        
      ...
      var rut=$("#rut_na").val();      
      var control=$("#control_na").val();
      var documento=$("#documento_na").val();
      var siglas=$("#siglas_na").val();
      ...
      if (mensaje_nax=='') {
         ...
         $.ajax({
            method: "POST",
            url: "add/addnoaplica_vehiculo.php",
            data:'contratista='+contratista+'&doc='+doc+'&mensaje='+mensaje_nax+'&mandante='+mandante+'&contrato='+contrato+'&trabajador='+trabajador+'&rut='+rut+'&control='+control+'&siglas='+siglas, 
            success: function(data){
                  if (data==0) {
                        swal({
                        ...
                        $("#modal_no_aplica").on('hidden.bs.modal', function () {   
                         ...
                         //sin documento
                         if (estado==1) {
                            var url='doc/temporal/'+mandante+'/'+contratista+'/contrato_'+contrato+'/vehiculos/'+siglas+'/'+documento+'_'+siglas+'.pdf';
            ...
            <div id="wrapper">
                ...
                <?php include('superior.php') ?> 
                    ...
                    <div style="" class="row wrapper white-bg ">
                        <div class="col-lg-10">
                            <h2 style="color: #010829;font-weight: bold;">DOCUMENTOS DEL VEHÍCULO <?php  ?></h2>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ibox ">
                                        <div class="ibox-title">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12 col-sm-12 col-sm-offset-2">
                                                    ...
                                                    <a  class="btn btn-sm btn-success btn-submenu" href="vehiculos_asignados_contratista.php" class="" type="button"><i class="fa fa-chevron-right" aria-hidden="true"></i> Gestion de Vehículos/Maquinaria</a>
                                                </div>
                                            </div> 
                                ...
                                <div class="ibox-content">
                                                ...
                                                <tr>
                                                                ...
                                                                if (empty($result_trabajador['url_foto'])) { ?>                                                                    
                                                                        <td class="fondo_td" rowspan="8">
                                                                            ...
                                                                            <div style="background: #1C84C6;color:#fff;width:100%;padding:2%;margin-top:1%"  class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    ...
                                                                                    <input onchange="agregar_foto_contrato(<?php echo $id ?>,<?php echo $contrato ?>,<?php echo $contratista ?>,<?php echo $mandante ?>,<?php echo $idcargo ?>,<?php echo $perfil ?>,'<?php echo $siglas?>')"  type="file" id="foto" name="foto" accept="image/jpeg,image/jpg" /></span>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        if ($result_trabajador['foto_asignada']=="") { ?> 
                                                                            ...
                                                                            <td class="fondo_td" rowspan="8">                                                                                                                                                                                                                                            
                                                                                    ...
                                                                                    <div style="background: #1C84C6;color:#fff;width:100%;padding:2%;margin-top:2%;">
                                                                                        <button id="btn-agregar" type="button" style="border:1px #fff solid" class="btn btn-success btn-md btn-block"  onclick="agregar_foto_al_contrato(<?php echo $id ?>,<?php echo $contrato ?>,<?php echo $contratista ?>,<?php echo $mandante ?>,<?php echo $idcargo ?>,<?php echo $perfil ?>,'<?php echo $siglas ?>')">Agregar al Contrato</button>
                                                                                    </div>
                                                                            </td>
                                                                        ...
                                                                        # si ya tienen asignada al contrato
                                                                            ...
                                                                            <td class="fondo_td" rowspan="8">
                                                                                ...
                                                                                <div style="background: #1C84C6;color:#fff;width:100%;padding:2%;margin-top:1%;"  class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    ...
                                                                                    <span id="btn-agregar" class="fileinput-exists">Cambiar Foto</span>
                                                                                    <input onchange="cambiar_foto('<?php echo $siglas ?>',<?php echo $contrato ?>,<?php echo $id ?>,<?php echo $perfil ?>)"  type="file" id="foto" name="foto" accept="image/jpeg,image/jpg,image/png" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="" ><label class="col-form-label"><?php echo $result_contrato['nombre_contrato'] ?></label></td>
                                                    </tr> 


                                                    <tr>
                                                        <td class="fondo" ><label class="col-form-label"><b> Vehiculo/Maquinaria </b></label></td>
                                                        <td><label class="col-form-label"><?php echo $result_trabajador['tipo'].' '.$marca.' '.$modelo.' '.$year  ;?></label></td>
                                                    </tr> 
                                                    <tr>
                                                        <td class="fondo" ><label class="col-form-label"><b> Patente </b></label></td>
                                                        <td><label class="col-form-label"><?php echo $patente ?></label></td>
                                                    </tr> 
                                                    <tr>
                                                        <td class="fondo" ><label class="col-form-label"><b> Sigla </b></label></td>
                                                        <td><label class="col-form-label"><?php echo $siglas ?></label></td>
                                                    </tr> 
                                                    <tr>
                                                        <td class="fondo" ><label class="col-form-label"><b> Documentos </b></label></td>
                                                        <?php 
                                                            $rut_t=$result_trabajador['rut'];
                                                            $url ='doc/validados/'.$_SESSION['mandante'].'/'.$_SESSION['contratista'].'/contrato_'.$_SESSION['contrato'].'/vehiculos/'.$siglas.'/'.$result_ta['codigo'].'/zip/documentos_validados_vehiculos_'. $siglas.'.zip';
                                                            if ($existe_acreditado!=0) {  
                                                                
                                                                        # sin foto en el contrato acreditado
                                                                        if ($result_ta['url_foto']=="") { ?>
                                                                            <td ><label class="col-form-label text-danger"><b>Vehiculo Sin Foto</b></label></td>              
                                                                        <?php 
                                                                ...
                                                                <td ><label style="font-size:12px" class="col-form-label badge badge-danger"><b>Vehículo No Acreditado</b></label></td>
                                                            <?php } ?>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php 
                                                            if ($existe_acreditado!=0) { 
                                                                # sin foto en el contrato acreditado
                                                                    if ($result_ta['url_foto']=="") { ?>
                                                                    <td ><label class="col-form-label text-danger"><b>Vehículo Sin Foto</b></label></td>            
                                                            <?php 
                                                                # si hay foto en el contrato
                                                                  } else { ?>        
                                                                    <td ><label class="col-form-label"><a style="margin-left: 2%;text-decoration:underline" class="" href="credencial_vehiculo.php?codigo=<?php echo $result_ta['codigo'] ?>" target="_blank"><b>Descargar</b></a></label></td>
                                                            <?php } ?>                
                                                        <?php } else { ?>
                                                                 <td ><label style="font-size:12px" class="col-form-label badge badge-danger"><b>Vehículo No Acreditado</b></label></td> 
                                    ...
                                    if($existe_acreditado==0) { ?>
                                        ...
                                        <div style="margin-top:3%" class="row">                            
                                                ...
                                                <?php $i=0; 
                                                        ...
                                                        foreach ($doc as $row) {
                                                            $cont_doc=$cont_doc+1; 
                                                            $sql=mysqli_query($con,"select * from doc_autos where id_vdoc='$row' ");  
                                                            ...
                                                            $query_com_existe=mysqli_query($con,"select * from comentarios where id_obs='".$result_obs['id_obs']."' and doc='".$result['documento']."'  order by id_com desc ");
                                                            $existe_com=mysqli_num_rows($query_com_existe);

                                                            $query_noaplica=mysqli_query($con,"select * from noaplica_vehiculo where documento='$row' and contrato='$contrato' and vehiculo='$id' ");
                                                            $resul_noaplica=mysqli_fetch_array($query_noaplica);
                                                                                                                 
                                                            
                                                            $carpeta_c='doc/vehiculos/'.$contratista.'/'.$siglas.'/'.$result['documento'].'_'.$siglas.'.pdf';
                                                            
                                                        if ($existe_acreditado¡=0) {                                           
                                                                $carpeta='doc/validados/'.$_SESSION['mandante'].'/'.$_SESSION['contratista'].'/contrato_'.$_SESSION['contrato'].'/vehiculos/'.$siglas.'/'.$result_ta['codigo'].'/'.$result['documento'].'_'.$siglas.'.pdf';
                                                            } else { 
                                                                $carpeta='doc/temporal/'.$_SESSION['mandante'].'/'.$_SESSION['contratista'].'/contrato_'.$_SESSION['contrato'].'/vehiculos/'.$siglas.'/'.$result['documento'].'_'.$siglas.'.pdf';
                                                            } 
                                                            ...
                                                            <?php
                                                                    ...
                                                                    if ($archivo_existe_c) {  ?>
                                                                            <td style="text-align:center">                                                                                    
                                                                                    <input style="margin-left: 10%;" class="estilo2" type="checkbox" name="doc_existe[]" id="doc_existe<?php echo $i ?>" value="0" onclick="seldoc(this,<?php echo $i ?>)"  />
                                                                            </td>
                                                                    ...
                                                                    <?php 
                                                                            ...
                                                                            <td style="text-align:center">                                                                                    
                                                                                    <input disabled style="margin-left: 10%;" class="estilo2" type="checkbox" name="doc_existe[]" id="doc_existe<?php echo $i ?>" value="0" onclick="seldoc(this,<?php echo $i ?>)"  />
                                                                            </td> 
                                                                            <!-- cargado -->
                                                                            <td style="text-align:center;border-right:1px solid #BFC6D4">                                                                                
                                                                ...
                                                                if ($archivo_existe) { ?>
                                                                    <!-- documento  -->
                                                                    <td id="td_documento<?php echo $i ?>" ><a href="<?php echo $carpeta ?>" target="_blank"><?php echo $result['documento'] ?></a></td>
                                                                    <?php                                                                 
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group"> 
                                                                                <?php if ($existe_com>0) { ?>
                                                                                    ...
                                                                                    <button class="btn btn-sm btn-success" type="button" onclick="modal_ver_obs(<?php echo  $row ?>,<?php echo $contrato ?>,<?php echo $id ?>)"><i style="color: ;font-size: 20px;" class="fa fa-search-plus" aria-hidden="true"></i></button>
                                                                                <?php } else { ?>
                                                                                        <textarea cols="50" rows="1" name="mensaje[]" id="mensaje<?php echo $i ?>" class="form-control" readonly=""><?php echo $list_com ?></textarea>
                                                                    ...
                                                                    <?php if ($result_com['doc']==$result['documento']) {
                                                                                    ...
                                                                                    if ($result_com['leer_mandante']==0 and $result_com['leer_contratista']==0) { 
                                                                                        ...
                                                                                        if (isset($resul_noaplica['documento'])==isset($row)) { ?>
                                                                                            ...
                                                                                            <td style="text-align: center;"><input class="estilo" name="aplica[]" id="aplica<?php echo $i ?>" type="checkbox" onclick="modal_no_aplica(<?php echo $row ?>,<?php echo $i ?>,'<?php echo $result['documento'] ?>',<?php echo $contratista ?>,<?php echo $mandante ?>,<?php echo $contrato ?>,<?php echo $id ?>,'<?php echo $rut ?>',<?php echo $control ?>,'<?php echo $siglas ?>' )" value="<?php echo $row  ?>" checked /></td>
                                                                                        <?php 
                                                                                        } else { ?>
                                                                                            ...
                                                                                            <td style="text-align: center;"><input class="estilo" name="aplica[]" id="aplica<?php echo $i ?>" type="checkbox" onclick="modal_no_aplica(<?php echo $row ?>,<?php echo $i ?>,'<?php echo $result['documento'] ?>',<?php echo $contratista ?>,<?php echo $mandante ?>,<?php echo $contrato ?>,<?php echo $id ?>,'<?php echo $rut ?>',<?php echo $control ?>,'<?php echo $siglas ?>' )" value="<?php echo $row  ?>"  /></td>
                                                                                        <?php 
                                                                                        }  ?>
                                                                    ...
                                                                    # si esta verificado
                                                                        ...
                                                                        <td>
                                                                            <div class="btn-group"> 
                                                                                ...
                                                                                <button title="Historial de Observaciones" class="btn btn-sm btn-success" type="button" onclick="modal_ver_obs(<?php echo $row ?>,<?php echo $result_obs['id_obs'] ?>,0)"><i style="color: ;font-size: 20px;" class="fa fa-search-plus" aria-hidden="true"></i></button>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td  style="text-align:center">
                                                                                ...
                                                                                <div style="background: #969696;" class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    <span  style="background: #969696;color: #fff;border:#969696;width:100%" class="btn btn-default btn-file"><span id="texto<?php echo $i ?>" class="fileinput-new">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Validado&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                            ...
                                                            # si archivo no existe  
                                                                ...
                                                                <td  style="text-align:center">
                                                                        <div  class="fileinput fileinput-new" data-provides="fileinput">
                                                                            <span  style="background: #282828;color: #000;border:#282828;color:#fff" class="btn btn-default btn-file"><span id="texto<?php echo $i ?>" class="fileinput-new">Seleccionar Archivo</span>
                                                                            <span  class="fileinput-exists">Cambiar</span><input class="archivo"  type="file" id="carga_doc_t<?php echo $i ?>" name="carga_doc_t[]" accept="application/pdf"   /></span>
                                                                            <span class="fileinput-filename"></span>                                                             
                                                                            <a title="Quitar" href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none"> <i class="fa fa-times-circle" aria-hidden="true"></i></a>
                                                                        </div>
                                                                </td>
                                                                ...
                                                                <!-- esTado -->                                                                    
                                                                <td style="text-align:center;font-size:14px;font-weight:700"><div id="estado<?php echo $i ?>" class="bg-danger p-xxs text-mute">NO ENVIADO</div></td>
                                                                    
                                                            </tr> 
                                                                
                                                            <?php } ?> 
                                                    <?php                                      
                                                        echo '<input type="hidden" name="cadena_doc[]" id="cadena_doc'.$i.'" value="'.$result['id_vdoc'].'" />';
                                                        echo '<input type="hidden" name="comentario[]" id="comentario'.$i.'" value="'.$result_com['id_com'].'" />';
                                                        $i++;
                                                     }   
                                                            $query_com=mysqli_query($con,"select * from comentarios where doc='Foto del vehiculo' and trabajador='$id' and estado='0' order by id_com desc ");
                                                            $result_com=mysqli_fetch_array($query_com);
                                                            $list_com=($result_com['comentarios']); 

                                                            $query_com_existe_foto=mysqli_query($con,"select * from comentarios where doc='Foto del vehiculo' and trabajador='$id' order by id_com desc ");
                                                                        ...
                                                                        <td>
                                                                            <div class="btn-group"> 
                                                                                <?php if ($existe_com_foto>0) { ?>
                                                                                    <textarea cols="50" rows="1" name="mensaje[]" id="mensaje<?php echo $i ?>" class="form-control" readonly=""><?php echo $list_com ?></textarea>
                                                                                    <button title="Historial de Observaciones" class="btn btn-sm btn-success" type="button" onclick="modal_ver_obs(10,<?php echo $contrato ?>,<?php echo $id ?>)"><i style="color: ;font-size: 20px;" class="fa fa-search-plus" aria-hidden="true"></i></button>
                                                                                <?php } else { ?>
                                                                                    <textarea cols="50" rows="1" name="mensaje[]" id="mensaje<?php echo $i ?>" class="form-control" readonly=""></textarea>
                                                                                    <button title="Historial de Observaciones" class="btn btn-sm btn-success" type="button" disabled><i style="color: ;font-size: 20px;" class="fa fa-search-plus" aria-hidden="true"></i></button>
                                                                                <?php }  ?>
                                                            ...
                                                            <tr style="border:1px #c0c0c0 solid;border-radius:10px;">
                                                                <td  colspan="7" >
                                                                        <button style="font-size:16px" title="Procesar Documentos" class="btn-success btn btn-md col-5" type="button" onclick="cargar_doc_trabajador(<?php echo $i ?>,'<?php echo $siglas ?>','<?php echo $result_contrato['nombre_contrato'] ?>')" >ENVIAR DOCUMENTOS <?php  ?></button>
                                                                </td>
                                                            </tr>
                                                ...
                                                <table class="table table-stripped" data-page-size="15" data-filter="#filter">
                                                    <thead>
                                                        <tr style="background: #010829;color:#fff">
                                                            <th style="width: 3%;" >#</th>
                                                            <th style="width: 97%;">Documentos Acreditados del Vehículo</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php 
                                                                ...
                                                                foreach ($doc_ta as $row) {
                                                                    ...
                                                                    $carpeta='doc/validados/'.$mandante.'/'.$contratista.'/contrato_'.$contrato.'/vehiculos/'.$siglas.'/'.$result_ta['codigo'].'/'.$result['documento'].'_'.$siglas.'.pdf';
                                                                ?>        
                                                                <tr>
                                                                    <td><?php echo $i ?></td>
                                                                ...
                                                                <?php    
                                                                    ...
                                                                    foreach ($query_dm as $row) {
                                                                        $carpeta_d= 'doc/validados/'.$row['mandante'].'/'.$row['contratista'].'/contrato_'.$row['contrato'].'/vehiculo/'.$siglas.'/'.$result_ta['codigo'].'/'.$row['documento'].'_'.$siglas.'_'.$row['mes'].'_'.$row['year'].'.pdf';; 
                                                                ?>
                                                                ...
                                                                <?php
                                                                    $query_de2=mysqli_query($con,"select d.* from documentos_extras as d where d.contrato='".$contrato."' and trabajador='".$id."' and d.tipo=2 and d.estado=3 ");
                                                                    ...
                                                                    # si hay documentos extras tipo 2                                               
                                                                        ...
                                                                        foreach ($query_de2 as $row) { 
                                                                            $carpeta = 'doc/validados/'.$mandante.'/'.$contratista.'/contrato_'.$contrato.'/vehciulo/'.$siglas.'/'.$result_ta['codigo'].'/'.$row['documento'].'_'.$siglas.'.pdf'; 
                                                            ...
                                                            <?php
                                                                    $query_de2=mysqli_query($con,"select d.* from documentos_extras as d where d.contrato='".$contrato."' and trabajador='".$id."' and d.tipo=3 and d.estado=3 ");
                                                                    $result_de=mysqli_fetch_array($query_de2);
                                                                    $cantidad2=mysqli_num_rows($query_de2);
                                                                    ...
                                                                    # si hay documentos extras tipo 2                                               
                                                                        ...
                                                                        $existe=0;
                                                                        foreach ($query_de2 as $row) { 
                                                                            $carpeta = 'doc/validados/'.$mandante.'/'.$contratista.'/contrato_'.$contrato.'/vehiculos/'.$siglas.'/'.$result_ta['codigo'].'/'.$row['documento'].'_'.$siglas.'.pdf'; 
                                ...
                                <input type="hidden" name="trabajador" id="trabajador" value="<?php echo $id ?>" /> 
                                <div class="form-group row">
                                    <div class="col-12">
                                ...
                                <script>
                                    ...
                                    function modal_ver_obs(id_doc,contrato,id) {
                                        //alert(id_doc+' '+id_obs);
                                        var condicion=0;
                                        $('.body').load('selid_ver_obs_vehiculos.php?doc='+id_doc+'&id='+id+'&contrato='+contrato,function(){
                                            $('#modal_ver_obs').modal({show:true});
                                        });
                                    } 

                                    function modal_no_aplica(id_doc,num,doc,contratista,mandante,contrato,id,rut,control,siglas) {       
                                    ...
                                    if ($('#aplica'+num).is(':checked')) {                                        
                                        ...
                                        $('#modal_no_aplica #control_na').val(control)
                                        $('#modal_no_aplica #documento_na').val(doc)
                                        $('#modal_no_aplica #siglas_na').val(siglas)
                                        ...
                                        swal({
                                            ...
                                            $.ajax({
                                                        method: "POST",
                                                        url: "add/addquitarnoaplica_vehiculo.php",
                                                        data:'contratista='+contratista+'&doc='+id_doc+'&mandante='+mandante+'&rut='+rut+'&contrato='+contrato+'&trabajador='+id+'&control='+control+'&siglas='+siglas, 
                                                        success: function(data){
                                                            if (data==0) {                    
                                                                ...
                                                                swal({
                                                                    title: "Documento Vehículo No Aplica Retirado",
                                                                    //text: "Un Documento no validado esta sin comentario",
                                                                    type: "success"
                                                                })                                                                
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content animated fadeIn">
                                            <div style="background:#e9eafb;color:#282828;text-align:center" class="modal-header">
                                                ...
                                                <h3 style="font-weight:bold;" id="titulo" class="modal-title">Docs. No Aplica Vehículo</h4>
                                            </div>                                    
                                            ...
                                            <input type="hidden" id="control_na" name="control_na" >
                                            <input type="hidden" id="siglas_na" name="siglas_na" >
