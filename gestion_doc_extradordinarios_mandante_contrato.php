...
$query_doc=mysqli_query($con,"select  d.estado as estado_doc, d.*, c.* from documentos_extras as d left join contratistas as c On c.id_contratista=d.contratista where d.contratista='".$_SESSION['contratista']."' and d.mandante='".$_SESSION['mandante']."' and d.tipo=2 and d.estado!='3' ");
                            ...
                            <div class="row">
                              <div class="col-12">
                                ...
                                <?php                                           
                                    if ($_SESSION['contratista']!="") { ?>                                     
                                    <div class="row">
                                        <label style="background:#e9eafb;color:#282828;font-weight:bold;border-bottom:2px solid #fff"   class="col-2 col-form-label"><b> RUT </b></label>
                                        <div style="font-weight:bold;border-bottom:2px solid #fff" class="col-4">
                                ...
                                <div class="row">                                                                    
                                    <label style="background:#e9eafb;color:#282828;font-weight:bold;bold;border-bottom:2px solid #fff"  class="col-2 col-form-label">Contrato</label>
                                        <div style="font-weight:bold;bold;border-bottom:2px solid #fff" class="col-4">                                             
                                                         ...
                                                         <div class="row">                            
                                                           ...
                                                           <input type="hidden" id="cant_trab_acre" value="<?php echo $result_cant_de_a['num_tra_acre'] ?>" />
                                                            <?php if ($cantidad_de!=0) { ?>
                                                                <div style="color:#282828;padding: 0.5% 0%;border:1px #c0c0c0 solid" class="row">
                                                                    <div class="col-4">
