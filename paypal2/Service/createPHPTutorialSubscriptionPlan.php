...
$merchantPreferences->setReturnUrl('https://facilcontrol.cl/paypal2/index.php?status=success')
    ->setCancelUrl('https://facilcontrol.cl/paypal2/index.php?status=cancel')
