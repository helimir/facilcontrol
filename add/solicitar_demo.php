...
$fecha =make_date();
$telefono="569".$_POST['telefono'];
   
$consulta="insert into solicitudes (nombre,email,telefono,empresa,tipo,trabajadores) values ('".$_POST['nombre']."','".$_POST['email']."','".$telefono."','".$_POST['empresa']."','".$_POST['tipo']."','".$_POST['trabajadores']."') ";    
...
if ($sql_contratista) {
                            ...
                            * {
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td class="content-block">
                                                                    Estimado:<strong>'.$_POST['nombre'].'</strong>.<br/>
                                                                    Empresa:<strong>'.$_POST['empresa'].'</strong>.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content-block">
                                                                    Felicitaciones por querer mejorar el sistema de gesti&oacute;n de tu empresa,  lo antes posible se contactara contigo un ejecutivo de F&aacute;cil Control para hacerte una demostraci&oacute;n gratis.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content-block">
                            ...
                            $mail->FromName = 'Facil Control';   /*Puedes poner tu nombre, el de tu empresa, nombre de tu web, etc.*/
                            
                            //CONFIGURACI�N DEL MENSAJE, EL CUERPO DEL MENSAJE SERA UNA PLANTILLA HTML QUE INCLUYE IMAGEN Y CSS
                            $mail->Subject = 'Demostracion Facil Control'; //asunto del mensaje
                            ...
                            $mail->addAddress("helimirlopez@gmail.com");
                            $mail->addAddress("ariel@erachile.cl");
