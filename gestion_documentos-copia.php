                               ...
                               <?php 
                                ...
                                <?php 
                                    # contratista con un solo mandante
                                        ...
                                        <div class="col-12">
                                            <div class="row">                                                                    
                                                <label  class="col-lg-2 col-sm-12 col-form-label fondo"><b> Mandante</b></label>
                                                        <?php
                                                            $query=mysqli_query($con,"select razon_social,id_mandante from mandantes where id_mandante='".$_SESSION['mandante']."' ");
                                                            $result=mysqli_fetch_array($query);     
                                                        ?>
                                                        <label  class="col-lg-6 col-sm-6 col-form-label"><?php echo $result['razon_social'] ?></label>
                                            </div>
                                            <div class="row">                                                                    
                                                ...
                                                <table style="width: 100%;" class="footable table" data-page-size="25" data-filter="#filter">
                                                    <thead >
                                                        <tr>
                                                            ...
                                                            <th style="width: 28%;visibility:collapse; display:none;" data-hide="phone">Observaciones</th>
                                                                    ...
                                                                    if ($list_veri[$i]==0 ) { ?>
                                                                        ...
                                                                        if ($result_com['doc']==$result['documento']) {
                                                                                if ($result_com['leer_mandante']==1 and $result_com['leer_contratista']==1) { 
                                                                                    ...
                                                                                    <td style="text-align:center;"><div id="estado<?php echo $i ?>" style="font-size:14px" class="bg-warning p-xxs">EN PROCESO</div></td>
                                                                                <?php
                                                                                }      
                                                                            ...
                                                                            <?php }
                                                                                        ...
                                                                                        <td style="text-align:center"><div id="estado<?php echo $i ?>" style="font-size: 14px;" class="bg-info p-xxs"><b>EN PROCESO</b></div></td>
                                                                        <?php }      
