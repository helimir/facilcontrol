...
if (isset($_SESSION['usuario'])  ) { 
    ...
    $Name = 'Reporte_mandante_trabajadores_'.$fecha.'_'.$hora.'.csv';
    $FileName = "./$Name";
    $Datos = 'Id;Contratista;Trabajador;RUT;Direccion;Email;Telefono;Fecha_Nac;Estado_Civil';
    $Datos .= "\r\n";
...
foreach ($RsSql as $oRow) {
    ...
    $Datos .= $oRow['idtrabajador'].";".$oRow['razon_social'].";".utf8_decode($trabajador).";".$oRow['rut'].";".utf8_decode($direccion).";".$oRow['email'].";".$oRow['telefono'].";".$fecha_nac.";".$oRow['estadocivil'];
    $Datos .= "\r\n"; 
    $i=$i+1; 
