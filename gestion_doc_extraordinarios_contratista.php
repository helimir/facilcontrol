...
<script>
 ...
 $(document).ready(function (){
    ...
    function cargar_doc_extra(total,mandante,tipo,doc){
          //alert(total)
    ...
    function guardar_no_aplica(mandante) {        
      ...
      if (mensaje_nax=='') {
         ...
         $.ajax({
            ...
            data:'contratista='+contratista+'&doc='+doc+'&mensaje='+mensaje_nax+'&mandante='+mandante+'&documento='+documento+'&tipo='+tipo, 
            success: function(data){
                  if (data==0) {
                        swal({
                            title: "Documento Enviado",
...
<body>
    ...
    <div id="wrapper">
       ...
       <div style="" class="row wrapper white-bg ">
          <div class="col-lg-10">
              <h2 style="color: #010829;font-weight: bold;">Documentos Extraordinarios Contratista <?php  ?></h2>
                    ...
                    <div class="ibox ">
                             <div class="ibox-title">
                                 <div class="form-group row">
                                   <div class="col-lg-12 col-sm-12 col-sm-offset-2">                                           
                                           ...
                                           <a class="btn btn-sm btn-success btn-submenu"  href="list_doc_extras_contratista.php" class="" ><i class="fa fa-chevron-right" aria-hidden="true"></i> Documentos Extraordinarios</a>
                        ...
                        <?php 
                            # contratista con un solo mandante
                                ...
                                <div class="row">                                                                    
                                    <label style="background:#e9eafb;color:#282828;font-weight:bold"  class="col-2 col-form-label">Mandante</label>
                                ...
                                <table class="table table-stripped" data-page-size="15" data-filter="#filter">
                                   <thead style="background:#e9eafb;color:#282828;font-weight:bold">
                                    <tr>
                                        ...
                                        <th style="width: 20%;text-align: center;border-right:1px #fff solid">Adjuntar</th>
                                   ...
                                   <tbody>
                                    ...
                                    $query_doc=mysqli_query($con,"select d.estado as estado_doc, c.rut, d.* from documentos_extras as d LEFT JOIN contratistas as c On c.id_contratista=d.contratista where d.contratista='$contratista' and d.mandante='".$_SESSION['mandante']."' and d.tipo=1 and d.estado!='3' ");
                                    ...
                                    if ($cantidad_de!=0) {
                                     ...
                                     if ($_SESSION['mandante']!=0 ) {    
                                         ...
                                         foreach ($query_doc  as $row) {
                                            ...
                                            $query_noaplica=mysqli_query($con,"select * from noaplica where documento='".$row['id_de']."' and contratista='$contratista' and mandante='$mandante' and tipo='1' ");
                                                   ...
                                                   <td>
                                                    ...
                                                    <td tyle="text-align:center">
                                                          <?php if ($row['estado_doc']!=3) { ?>  
                                                            <button style="background: #292929;color:#fff" class="btn btn-md btn-primary btn-block" onclick="simultanea(<?php echo $row['tipo'] ?>,<?php echo $mandante ?>,<?php echo $contratista ?>,<?php echo $row['estado_doc'] ?>,<?php echo $row['id_de'] ?>)" >Seleccionar</button>
                                                        <?php } else { ?>  
                                                        ...
                                                        <?php if ($resul_noaplica['documento']==$row['id_de']) { ?>                                                                    
                                                                <?php if ($row['estado_doc']!=3) { ?>
                                                                        <td style="text-align: center;"><input class="estilo" name="aplica[]" id="aplica<?php echo $i ?>" type="checkbox" onclick="modal_no_aplica(<?php echo $row['id_de'] ?>,<?php echo $i ?>,'<?php echo $row['documento'] ?>',<?php echo $contratista ?>,<?php echo $mandante ?>,'<?php echo $rut ?>',1)" value="<?php echo $row  ?>" checked  /></td>
                                                                <?php  } else { ?>        
                                                        ...
                                                        <?php         }  
                                                                ...
                                                                <?php if ($row['estado_doc']!=3) { ?>                                                                                                                                
                                                                        <td style="text-align: center;"><input class="estilo" name="aplica[]" id="aplica<?php echo $i ?>" type="checkbox" onclick="modal_no_aplica(<?php echo $row['id_de']?>,<?php echo $i ?>,'<?php echo $row['documento'] ?>',<?php echo $contratista ?>,<?php echo $mandante ?>,'<?php echo $rut ?>',1)" value="<?php echo $row  ?>" /></td>
                                                                <?php  } else { ?>  
                                                    ...
                                                    <td style="text-align:center">
                                                        ...
                                                        <?php if ($row['estado_doc']==0) { ?>
                                                            <div style="font-size: 14px;" class="bg-danger p-xxs "><small><b>NO ENVIADO</b></small></div> 
                                                        <?php } ?>
               ...
               <!--</form>-->
                        ...
                        <script>
                               ...
                               function modal_ver_obs(id) {
                                ...
                                function simultanea(tipo,mandante,contratista,estado,doc) {
                                     //alert(tipo+' '+mandante+' '+contratista+' '+estado+' '+doc)
                                      $('.body').load('selid_simultaneo_extra.php?tipo='+tipo+'&mandante='+mandante+'&contratista='+contratista+'&estado='+estado+'&doc='+doc,function(){
                                         $('#modal_simultaneo').modal({show:true});
                                     });   
                                }     

                                function modal_no_aplica(id_doc,num,doc,contratista,mandante,rut,tipo) {     
                                    ...
                                    if ($('#aplica'+num).is(':checked')) {                                        
                                        ...
                                        swal({
                                            ...
                                            $.ajax({
                                                        ...
                                                        data:'contratista='+contratista+'&mandante='+mandante+'&documento='+doc+'&rut='+rut+'&tipo='+tipo, 
                                                        success: function(data){
                                                            if (data==0) {                    
                        ...
                        <div class="modal inmodal" id="modal_simultaneo" tabindex="-1" role="dialog" aria-hidden="true">                            
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content animated fadeIn">
                                                <div style="background:#e9eafb;color:#282828" class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>                                           
                                                    <h4 class="modal-title">Adjuntar Docs Extraordinarios</h4>
                                                </div>
                        ...
                        <div class="modal inmodal" id="modal_archivos_empresa" tabindex="-1" role="dialog" aria-hidden="true">
                                <div  class="modal-dialog modal-lg">
                                    <div class="modal-content animated fadeIn">
                                        <div style="background: #010829;color: #FFFFFF;" class="modal-header">
                                            <h3 class="modal-title" id="exampleModalLabel"><i class="fa fa-info-circle" aria-hidden="true"></i> Adjuntar Documento Extraordinario</h3>
                                            <button style="color: #FFFFFF;" type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
