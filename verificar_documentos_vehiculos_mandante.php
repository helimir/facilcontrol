...
if (isset($_SESSION['usuario']) and $_SESSION['nivel']==2 ) {
 ...
 if (empty($_SESSION['vehiculo'])) {
    echo 'window.location.href="list_contratos.php";';
 }  else {
...
#$query_trabajador=mysqli_query($con,"select * from trabajador where idtrabajador='".$id."' ");
#$result_trabajador=mysqli_fetch_array($query_trabajador);

$query_trabajador=mysqli_query($con,"select a.url_foto as foto, t.* from autos as t Left Join vehiculos_asignados as a On a.vehiculos=t.id_auto where t.id_auto='".$id."' and a.contrato='$contrato' ");
$result_trabajador=mysqli_fetch_array($query_trabajador);
...
$query_obs=mysqli_query($con,"select * from observaciones_vehiculo where mandante='".$_SESSION['mandante']."' and contrato='".$_SESSION['contrato']."' and vehiculo='".$id."' and estado!='2' ");
$result_obs=mysqli_fetch_array($query_obs);
$list_veri=unserialize($result_obs['verificados']);

$query_ta=mysqli_query($con,"select * from vehiculos_acreditados where vehiculo='$id' and contrato='".$_SESSION['contrato']."' and mandante='".$_SESSION['mandante']."' and estado!='2' ");
...
<head>
    ...
    <title>FacilControl | Documentos Vehículos</title>
            ...
            swal({ 
                ...
                if (contador!=total_doc) {
                                ...
                                for (i=0;i<=total-1;i++) {
                                    ...
                                    $.ajax({
                          			    method: "POST",
                                        url: "enviar_observacion_vehiculo.php",
                             		    data: {data:json,data2:json2,data3:json3,contratista:contratista},
                                        cache: false,
                                        beforeSend: function(){
                                    ...
                                    if (isConfirm) {                
                                        ...
                                        for (i=0;i<=total-1;i++) {
                                            ...
                                            $.ajax({
                                                method: "POST",
                                                url: "enviar_observacion_vehiculo.php",
                                                data: {data:json,data2:json2,data3:json3,contratista:contratista,fecha_val:fecha_val,id_doc:id_doc,control_foto:control_foto},
                                                cache: false,
                                                beforeSend: function(){
                                                    const progressBar = document.getElementById('myBar');
                                                    const progresBarText = progressBar.querySelector('.progress-bar-text');
        ...
        <div id="page-wrapper" class="gray-bg">
           ...
           <?php include('superior.php') ?> 
            ...
            <div style="" class="row wrapper white-bg ">
                <div class="col-lg-10">
                    <h2 style="color: #010829;font-weight: bold;">Documentos de Vehículos <?php #echo $_SESSION['vehiculo']  ?></h2>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                               <div class="ibox-title">
                                    ...
                                    <div class="form-group row">
                                      <div class="col-lg-12 col-sm-12 col-sm-offset-2">
                                        ...
                                        <a class="btn btn-sm btn-success btn-submenu" href="gestion_vehiculos_mandantes.php" type="button"><i class="fa fa-chevron-right" aria-hidden="true"></i> Gestion de Vehiculos</a>
                                      </div>
                                   </div>   
                        ...
                        <table class="table table-responsive">
                                                            ...
                                                            if ($existe_acreditado!=0) {
                                                                ...
                                                                if ($result_ta['url_foto']=="") { ?>
                                                                        <td class="fondo_td"  rowspan="10" >
                                                                            <div style="width:100%">
                                                                                        <img width="100%" heigth="150" src="img/sinimagen.png" />
                                                                            </div>
                                                                        </td>         
                                                                <?php 
                                                                } else { ?>
                                                                        <td class="fondo_td"  rowspan="10" ><label class="col-form-label"><img width="150" heigth="150" src="<?php echo $result_ta['url_foto'] ?>" /></label></td>
                                                                <?php 
                                                                }     
                                                                ...
                                                                <?php       # si tiene una foto
                                                                } else { ?>   
                                                                        <td class="fondo_td"  rowspan="10" >
                                                                            <div style="width:100%">
                                                                                        <img width="100%" heigth="150" src="<?php echo $result_trabajador['foto'] ?>" />
                                                                            </div>
                                                                        </td>    
                                                    ...
                                                    <tr>
                                                        <td class="fondo" ><label class="col-form-label"><b>Vehículo/Maquinaria </b></label></td>
                                                        <td><label class="col-form-label"><?php echo $result_trabajador['tipo'].' '.$result_trabajador['marca'].' '.$result_trabajador['modelo'].' '.$result_trabajador['year']  ;?></label></td>
                                                    </tr> 
                                                    <tr>
                                                        <td class="fondo" ><label class="col-form-label"><b>Patente </b></label></td>
                                                        <td><label class="col-form-label"><?php echo $result_trabajador['patente']?></label></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fondo" ><label class="col-form-label"><b>SIGLAS</b></label></td>
                                       ...
                                       <!-- <div id="acreditacion" class="row"  style="display: none;">
                        ...
                        <?php if($existe_acreditado==0) { ?>                 
                                        ...
                                        <tbody>
                                            ...
                                            <?php          
                                                ...
                                                foreach ($documentos as $row) {
                                                    ...
                                                    $query_noaplica=mysqli_query($con,"select * from noaplica_vehiculo where documento='$row' and contratista='$contratista' and mandante='$mandante' and vehiculo='$id' ");
                                                    ...
                                                    if ($archivo_existe) {  ?>
                                                            ...
                                                            <input type="hidden" id="id_doc<?php echo $i?>" value="<?php echo $result['id_vdoc'] ?>" />
                                            ...
                                            if ($result_trabajador['foto']=="") { ?>
                                                    <tr>
                                                        <td>Foto del vehiculo</td>
                                                        <input type="hidden" id="doc<?php echo $i?>" value="Foto del vehiculo" />
                                            ...
                                            <?php 
                                                    ...
                                                    <tr>
                                                        <td>Foto del vehiculo</td>       
                                                        <input type="hidden" id="doc<?php echo $i?>" value="Foto del vehiculo" />     
                                                        <input type="hidden" id="id_doc<?php echo $i?>" value="10" />                                            
                                                            <?php 
                                                            if ($list_veri[$i]==0 ) { ?>
                                                                <td style="text-align: center;"><input class="estilo" type="checkbox" name="verificar[]" id="verificar_doc<?php echo $i ?>" onclick="deshabilitar(<?php echo  $i ?>) "  /></td>
                                                                <td>
                                                                    <div class="btn-group"> 
                                                                        <textarea cols="50" rows="1" name="mensaje[]" id="mensaje<?php echo $i ?>" class="form-control" ><?php echo $list_com ?></textarea>
                                                                        <button title="Historial de Observaciones" class="btn btn-sm btn-success" type="button" onclick="modal_ver_obs(10,<?php echo $result_com['id_obs'] ?>)" ><i style="color: ;font-size: 20px;" class="fa fa-search-plus" aria-hidden="true"></i></button>
                                                                    </div>
                                                                </td>
                                                                <?php
                                                                if (empty($list_com)) {  ?>
                                                                    <td style="text-align:center;font-size:14px;font-weight:700"><div class="bg-info p-xxs text-mute">RECIBIDA</div></td>
                                                                <?php 
                                                                } else { ?>
                                                                    <td style="text-align:center;font-size:14px;font-weight:700"><div class="bg-info p-xxs text-mute">OBSERVACION</div></td>
                                                                <?php 
                           ...
                           <?php if ($existe_acreditado==0) { ?> 
                                <div style="padding: 0.5% 0%;border:1px #c0c0c0 solid;border-radius:5px" class="form-group row">
                        ...
                        <script>
                            function modal_ver_obs(id_doc,id_obs) {
                                var condicion=0;
                                $('.body').load('selid_ver_obs_vehiculos.php?doc='+id_doc+'&id_obs='+id_obs+'&condicion='+condicion,function(){
                            ...
                            <div class="modal-content">
                              <div class="modal-body text-center">
                                <div class="loader"></div>
                                  <h3>Validando documentos, por favor espere un momento</h3>
                              </div>
                            </div>
                          </div>
                        </div>  
