   ...
   if ($existe==0) { 
        ...
        if ($estado==1) {
         ...
         if ($copiado) {
              ...
              $sql=mysqli_query($con,"insert into doc_observaciones (contratista,mandante,verificados,estado,creado,user,fecha,urls) values ('$contratista','$mandante','$veri','$estado','$date','$user','$date','$urls_serial')   ");
