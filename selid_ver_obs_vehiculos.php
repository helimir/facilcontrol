...
$sql=mysqli_query($con,"select * from doc_autos where id_vdoc='".$_GET['doc']."' "); 
$result=mysqli_fetch_array($sql);
       
 
$query=mysqli_query($con,"select * from comentarios where contrato='".$_GET['contrato']."' and doc='".$result['documento']."' and trabajador='".$_GET['id']."' and tipo='1' order by id_com desc ");
