	...
	if(!empty($txn_id)){
		...
		if($prevPayment->num_rows > 0){
			...
			if($insert){
				...
				$update = mysqli_query($con,"UPDATE registro SET estado='1', prueba='".$_SESSION['email']."', subscription_id = {$subscription_id} WHERE id_registro = {$custom}");

                                $select1=mysqli_query($con,"select * from registro where email='helimirlopez@gmail.com' ");
                                     ...
                                     <tr>
                                         ...
                                         <td class="container" width="600">
                                             <div class="content">
                                                 <table class="main" width="100%" cellpadding="0" cellspacing="0">
                                                     <tr>
                                                         <td  class="alert alert-good">                                                       
                                                             <h1 style="color: #ffffff;font-weight:800">SUSCRIPCIÓN</h1>
                                                         </td>
                                                     </tr>
                                                     <tr>
                                                             ...
                                                             <table width="100%" cellpadding="0" cellspacing="0">
                                                                 <tr>
                                                                     <td class="content-block">
                                                                         Estimad@: <strong>'.$nombre.'</strong>.<br/>
                                                                     </td>
                                                                 </tr>
                                                                 <tr>
                                                                     <td class="content-block">
                                                                         Muchas gracias por suscribirte con nosotros. Ingrese a nuestra plataforma para disfrutar de nuestros servicios.
                                                                     </td>
                                                                 </tr>                                                                                                                                                                                                                                                            
                                                                 <tr>
                                                                     <td class="content-block">
                                                 ...
                                                 <div style="background: #2EB8E2;" class="footer">
                                                     <table width="100%">
                                                         <tr style="font-weight:700;color:#282828">
                                                             <td class="aligncenter content-block">Email desde <a style="font-weight:700;color: #ffffff" href="#" >PreflopPerfect</a></td>
                                                         </tr>
                                                     </table>
                                                 </div>
                                             </div>
                            ...
                            $mail->Subject = 'Suscripción'; //asunto del mensaje
                            ...
                            $mail->addAddress('helimirlopez@gmail.com',$nombre);
