...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>PerflopPerfect-Registros</title>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="25">
                                        ...
                                        <tr>
                                            <th style="font-weight:bold !important" data-toggle="true">Nombre</th>
                                            <th style="font-weight:bold !important" data-hide="phone"> Nick </th>
                                            <th style="font-weight:bold !important"> Email </th>
                                            <th style="font-weight:bold !important" data-hide="phone"> Suscipción </th>
                                            <th style="font-weight:bold !important" data-hide="phone"> Pais </th>                                           
                                            <th data-hide="all"> IdCliente </th>
                                            <th data-hide="all"> Registro</th>
                                            <th data-hide="all"> Tarjeta </th>
                                            <th data-hide="all"> 4 Ultimos numeros</th>
                                            <th data-hide="all"> Modo de pago</th>                                            
                                            <th data-hide="all"> suscrito</th>
                                        </tr>
                                        </thead>
                                        <tbody style="font-size:14px">
                                            <?php foreach ($query as $row) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if (!empty($row['subscriptionId']) ) { ?>
                                                        <td><span style="font-size:16px" class="badge label-table badge-success"><?php echo $row['subscriptionId'] ?></span></td>
                                                    <?php } else { ?>
                                                        <td><span>Sin Suscripcion</span></td>
                                                    <?php } ?>
                                                    <td><?php echo $row['pais'] ?></td>
                                                    <!--<td><button type="button" class="btn btn-sm btn-danger waves-effect waves-light">eliminar</button><button type="button" class="btn btn-sm btn-danger waves-effect waves-light">eliminar</button></td>-->

                                                    <td><?php echo $row['id_custorm'] ?></td>
                                                    <td><?php echo $row['creado'] ?></td>
                                                    <td><?php echo $row['tipo_tarjeta'] ?></td>
                                                    <td><?php echo $row['numero_tarjeta'] ?></td>
                                                    <td><?php echo $row['modo_pago'] ?></td>
                                                    <?php if (!empty($row['subscriptionId']) ) { ?>
                                                        <td><span class="badge label-table badge-success">activo</span></td>
                                                    <?php } else { ?>
                                                        <td><span class="badge label-table badge-danger">disabled</span></td>
                                                    <?php } ?>
                                                </tr>
                                            <?php } ?>    
                                        </tbody>
