...
$query=mysqli_query($con,"SELECT f.*, r.nombre,r.plan,r.monto FROM facturas as f LEFT JOIN registro as r On r.id_custorm=f.custorm_id where f.estado='2' order by f.id_invoice desc ");
