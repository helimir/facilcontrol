...
if (isset($_SESSION['usuario']) ) {    
    ...
    $rut=isset($result_t['rut']) ? $result_t['rut']: '';
    ...
    if ($query_t) {
        ...
        if ($copiar) {
            mysqli_query($con,"update trabajadores_asignados set  url_foto='".$url."' where trabajadores='$trabajador' and contrato='$contrato'  ");            
