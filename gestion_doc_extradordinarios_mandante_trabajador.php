...
$query_doc=mysqli_query($con,"select  d.estado as estado_doc, d.*, c.* from documentos_extras as d left join contratistas as c On c.id_contratista=d.contratista where d.contratista='".$_SESSION['contratista']."' and d.mandante='".$_SESSION['mandante']."' and d.estado!='3' ");
                        ...
                        <div class="ibox-title">
                             <div class="form-group row">
                               <div class="col-lg-12 col-sm-12 col-sm-offset-2">
                                       <a class="btn btn-sm btn-success btn-submenu" href="notificaciones.php" class="" ><i class="fa fa-chevron-right" aria-hidden="true"></i> Notificaciones</a>
                            ...
                            <div class="row">
                              <div class="col-12">
                                ...
                                <div style="border-bottom:2px solid #fff;" class="row">                                                                    
                                    <label style="background:#BFC6D4;color:#282828;font-weight:bold"   class="col-2 col-form-label"><b>Contratista </b></label>
                                    <div style="background:#eee;;font-weight:bold" class="col-4">   
                                       <?php 
                                ...
                                <?php                                           
                                    if ($_SESSION['contratista']!="") { ?>                                     
                                    <div class="row">
                                        <label style="background:#BFC6D4;color:#282828;font-weight:bold;border-bottom:2px solid #fff"   class="col-2 col-form-label"><b> RUT </b></label>
                                        <div style="background:#eee;font-weight:bold;border-bottom:2px solid #fff" class="col-4">
                                    ...
                                    <!--<div class="row">
                                        ...
                                        <div style="" class="col-2">
                                            <?php if ($result_doc['acreditada']==1) { ?> 
                                                <p style="margin-top: 0.5%;"><span class="badge badge-success">Acreditada</span></p>
                                            <?php } else { ?>
                                                <p style="margin: 1%;"><span class="badge badge-danger">No Acreditada</span></p>
                                            <?php } ?>       
                                        </div>
                                    </div>-->
                                <?php } ?>
                                ...
                                <div class="row">                                                                    
                                    <label style="background:#BFC6D4;color:#282828;font-weight:bold;bold;border-bottom:2px solid #fff"  class="col-2 col-form-label">Contrato</label>
                                ...
                                <div class="row">            
                                    <?php #$carpeta='doc/temporal/'.$mandante.'/'.$contratista.'/contrato_'.$contrato.'/'.$result_trab['rut'].'/'.$result_trab['codigo'].'/'.$row['documento'].'_'.$result_trab['rut'].'.pdf'; ?>                                                        
                                    <label style="background:#BFC6D4;color:#282828;font-weight:bold;"  class="col-2 col-form-label">Documento</label>
                                        <div style="background:#eee;;font-weight:bold" class="col-4">                                             
                                            <!--label class="col-form-label"><a href="<?php echo $carpeta ?>" target="_blank"><?php echo $result_doc['documento'] ?></a></label>-->
                                            <label class="col-form-label"><?php echo $result_doc['documento'] ?></label>
                                    </div>
                                </div>
                                                         ...
                                                         <div class="row">                            
                                                                ...
                                                                <table class="table table-stripped">
                                                                   <thead style="background:#010829;color:#fff">
                                                                    <tr>
                                                                        ...
                                                                        <th style="width: 35%;border-right:1px #fff solid">Trabajador</th>
                                                                         ...
                                                                         foreach ($query_doc as $row) {
                                                                                 ...
                                                                                 <?php      } 
                                                                                    ...
                                                                                    <td style="text-align:center">
                                                                                        ...
                                                                                        <?php if ($row['estado_doc']==1) { ?>
                                                                                            <div style="font-size: 16px;" class="bg-info p-xxs"><small><b>RECIIDO</b></small></div>
                                                                                        <?php } ?>
                                                                            ...
                                                                            <?php # si archi no existe       
                                                                                    ...
                                                                                    $estado='1';?>
                                                                                        ...
                                                                                        <td style="text-align:center;"><div style="font-size: 16px;" class="bg-danger p-xxs "><small><b>SIN DOCUMENTO</b></small></div></td>              
                                                           ...
                                                           <input type="hidden" id="cant_trab_acre" value="<?php echo $result_cant_de_a['num_tra_acre'] ?>" />
                                                            <?php if ($cantidad_de!=0) { ?>
                                                                <div style="background:#010829;color:#fff;padding: 0.5% 0%" class="row">
                                                                    <div class="col-4">
