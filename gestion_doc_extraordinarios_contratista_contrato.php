...
if (empty($_SESSION['contratista'])) {
    $contratista=$_POST['id'];
} else {
    $contratista=$_SESSION['contratista'];
}

if (empty($_SESSION['mandante'])) {
    $mandnate=$_POST['mandante'];
} else {
...
$query_doc=mysqli_query($con,"select d.estado as estado_doc, c.rut, d.* from documentos_extras as d LEFT JOIN contratistas as c On c.id_contratista=d.contratista where d.contratista='$contratista' and d.mandante='".$mandante."' and d.tipo=2 and d.estado!='3' ");
                    ...
                    <div class="ibox ">
                                        ...
                                        <select name="contratista" id="contratista" class="form-control m-b"  onchange="selmandante(this.value)">
                                            <?php                                           
                                                ...
                                                if ($mandante=="") {
                                                    ...
                                                    $query=mysqli_query($con,"select razon_social,id_mandante from mandantes where id_mandante='".$mandante."' ");
                        ...
                        <?php 
                            # contratista con un solo mandante
                                ...
                                <div class="row">                                                                    
                                    <label style="background:#e9eafb;color:#282828;font-weight:bold;border-bottom:2px solid #fff"  class="col-2 col-form-label">Mandante</label>
                                        <div style="font-weight:boldfont-weight:bold;border-bottom:2px solid #fff" class="col-10">                                             
                         ...
                         <div class="row">                                                                    
                            <label style="background:#e9eafb;color:#282828;font-weight:bold;bold;border-bottom:2px solid #fff"  class="col-2 col-form-label">Contrato</label>
                                <div style="font-weight:bold;bold;border-bottom:2px solid #fff" class="col-10">                                             
                         ...
                         <div class="row">            
                            ...
                            <label style="background:#e9eafb;color:#282828;font-weight:bold;"  class="col-2 col-form-label">Documento</label>
                             ...
                             <div class="table table-responsive">
                                <table class="table table-stripped" data-page-size="15" data-filter="#filter">
                                   <thead class="cabecera_tabla">
                                    <tr>                                        
                                        <th style="width: 25%;border-right:1px #fff solid">Trabajador</th>
                                   ...
                                   <tbody>
                                    ...
                                    $query_obs=mysqli_query($con,"select * from doc_observaciones_extra where mandante='".$mandante."' and contratista='".$contratista."' ");
