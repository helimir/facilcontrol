...
$sql_doc=mysqli_query($con,"select * from doc_autos where estado=0  ");
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     ...
     <title>FacilControl | Perfil Vehiculos </title>
     <!-- Favicons -->
    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <?php include('superior.php'); ?>
            ...
            <div style="" class="row wrapper white-bg ">
                <div class="col-lg-10"> 
                    <h2 style="color: #010829;font-weight: bold;">CREAR PERFIL VEHÍCULO/MAQUINARIA <?php  ?></h2>
                </div>
            </div>
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form  method="post" id="frmPerfil">
                             ...
                             <div class="row"> 
                                <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12 text-left">
                                    <label style="#282828;font-weight:bold" class="col-form-label" for="quantity">Nombre del Perfil Vehiculos/Maquinarias</label> 
                                </div>                      
                                <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                 ...
                                 <table class="table">
                                    ...
                                    <tbody>
                                     <?php $i=0; foreach ($sql_doc as $row) {    
                                            if ($row['documento']!="Foto del vehiculo") { ?>
                                       <tr>                                          
                                            <td><input class="form-control" id="doc_perfil<?php echo $i ?>"  name="doc[]" type="checkbox" value="<?php echo $row['id_vdoc'] ?>" onclick="sel_doc(<?php echo $i ?>)" /> </td>
                                ...
                                <div style="border:1px #c0c0c0 solid;border-radius;5px;padding:1% 0%" class="form-group row">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <button class="btn btn-success btn-lg"  type="button" onclick="crear_perfil()"><strong>CREAR PERFIL DE VEHICULOS/MAQUINARIA</strong></button>
                                    </div>
                                </div>
                            </form>
                        </div>
      ...
      if (nombre!="") {
         ...
         if(doc.length <= 0){
            Swal.fire({
              ...
              $.ajax({
        			method: "POST",
                    url: "add/addperfil_vehiculos.php",
                    data: valores,
                     beforeSend: function(){
