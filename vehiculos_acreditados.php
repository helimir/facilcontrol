...
$year=date('Y');
    ...
    if  ($_SESSION['contrato_des']=="" or $_SESSION['contrato_des']==0) {
        ...
        $acreditados=mysqli_query($con,"select a.mandante as mandante_ta, m.razon_social as nombre_mandante, a.estado as estado_ta, a.contrato as contrato_ta, a.*, t.*, c.razon_social, o.id_contrato, o.nombre_contrato from vehiculos_acreditados as a LEFT JOIN autos as t ON t.id_auto=a.vehiculo LEFT JOIN contratistas as c ON c.id_contratista=a.contratista LEFT JOIN contratos as o ON o.id_contrato=a.contrato Left Join mandantes as m On m.id_mandante=a.mandante where a.contratista='".$_SESSION['contratista']."' and a.estado=0 and a.contrato='".$_SESSION['contrato_des']."' ");
    }        
...
<html translate="no">
    ...
    <title>FacilControl | Vehiculos acreditados</title> 
        ...
        <div id="page-wrapper" class="gray-bg">
           ...
           <?php include('superior.php') ?> 
             ...
             <div style="" class="row wrapper white-bg ">
                <div class="col-lg-10">
                    <h2 style="color: #010829;font-weight: bold;">Vehículos Acreditados <?php  ?></h2>
                </div>
            </div>
                    ...
                    <div class="ibox ">
                            <div class="ibox-title">
                                <div class="form-group row">
                                      ...
                                      <?php } else { ?>
                                        <a style="background:#217346;border:1px #217346 solid;color:#fff" class="btn btn-sm" href="excel/excel_acreditados_v.php"> <i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargar Acreditados</a>
                        ...
                        <div class="ibox-content">
                                            ...
                                            <label style="background:#BFC6D4;border-bottom: #fff 2px solid;color:#282828"  class="col-2 col-form-label"><b> Contratos</b></label>
                                                ...
                                                <div class="col-sm-6">    
                                                    <select name="contrato" id="contrato" class="form-control" onchange="selcontrato(this.value)">
                                                            ...
                                                            $query=mysqli_query($con,"select * from contratos where id_contrato='".$_SESSION['contrato_des']."' ");
                                            ...
                                            <div class="table-responsive">  
                                                ...
                                                <thead class="cabecera_tabla">
                                                    <tr>
                                                        ...
                                                        <th style="width: 30%;border-right:1px #fff solid;">Vehiculo</th>
                                                        <th style="width: 8%;border-right:1px #fff solid;">Patente</th>
                                                        <th style="width: 10%;border-right:1px #fff solid;">Codigo</th>
                                                        <th style="width: 15%;border-right:1px #fff solid;">Contrato</th>
                                                        <th style="width: 10%;border-right:1px #fff solid;" >Credencial</th>
                                                        <th style="width: 10%;border-right:1px #fff solid;" >Documentos</th>
                                                        <th style="width: 5%;border-right:1px #fff solid;">Acci&oacute;n</th>

                                                        <th data-hide="all">Siglas</th>    
                                                        <th data-hide="all">Mandante</th>
                                                        ...
                                                        <th data-hide="all" >Propietario</th>
                                                    ...
                                                    <tbody>
                                                                ...
                                                                $patente=$row['patente'];
                                                                $vehiculo=$row['tipo'].' '.$row['marca'].' '.$row['modelo'].' '.$row['year'];

                                                                $documentos='doc/validados/'.$row['mandante'].'/'.$_SESSION['contratista'].'/contrato_'.$row['contrato_ta'].'/vehiculos/'.$siglas.'/'.$row['codigo'].'/zip/documentos_validados_vehiculos_'.$siglas.'.zip'; 
                                                                ?> 
                                                                    <tr>
                                                                    <td data-toggle="true"></td>
                                                                        ...
                                                                        <?php if ($row['url_foto']!="") { 
                                                                                    if ($row['estado_ta']==0 or $row['estado_ta']==1) {    ?>
                                                                                            <td><a style="text-decoration:underline"  href="credencial_vehiculo.php?codigo=<?php echo $row['codigo'] ?>" target="_blank"> Descargar</a></td>
                                                                                <?php
                                                                                   } else { ?>
                                                                                            <td>Desvinculado</td>
                                                                                <?php       
                                                                        ...
                                                                        <td><?php echo $row['nombre_mandante']  ?></td>                                                                        <td><?php echo $row['revision']  ?></td>
